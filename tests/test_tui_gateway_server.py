...
def test_load_enabled_toolsets_rejects_disabled_mcp_env(monkeypatch, capsys):
    ...
    # Sorted core/configured toolsets. `delegation_control` and `kanban` are
    # non-configurable platform toolsets whose tools live in hermes-cli's
    # universe and are auto-recovered by _get_platform_tools.
    assert server._load_enabled_toolsets() == ["delegation_control", "kanban", "memory"]
