...
_HERMES_CORE_TOOLS = [
    ...
    "clarify",
    # Code execution + delegation lifecycle
    "execute_code", "delegate_task", "delegation_control",
    # Cronjob management
    "cronjob",
...
TOOLSETS = {
    ...
    "delegation_control": {
        "description": "Inspect and control top-level background delegations",
        "tools": ["delegation_control"],
        "includes": []
    },
